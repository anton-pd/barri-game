...
1. Landing first fold with the demo CTA and gameplay preview.
2. Demo transcript with objective and clue checklist visible.
3. Dice/pending roll state in the demo.
4. Scenario cabinet showing demo plus sealed full cases.
5. Full game session UI with chat, stats, inventory, and location/audio controls.
