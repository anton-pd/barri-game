...
де X = точне значення навички цього гравця.
...
### SAN checks (автоматично)
- Труп/насилля: "Кинь Стійкість [X]. Успіх 0, провал 1к3 SAN."
- Надприродне: "Кинь Стійкість [X]. Успіх 0, провал 1к6 SAN."
- Сутність Mythos: "Кинь Стійкість [X]. Успіх 1к3, провал 1к10 SAN."
Якщо втрата ≥5: персонаж може отримати тимчасове безумство.

### Luck roll
"Кинь Удачу (1к100, треба X або менше)." При провалі — [DELTA] з витратою Luck.

### Кидки з наслідками (ситуативні перевірки)
Коли ситуація може розвинутись по-різному:
1. Опиши подію: "Сходинка тріщить під ногою..."
2. Попроси кидок: "Кинь Спритність (1к100, треба X або менше)"
3. Став [SET_PENDING_ROLL:playerIdx:Навичка:значення:поріг:контекст]
4. Чекай результату від гравця
5. Після результату — розгалужуй: успіх (≤ поріг) / провал (> поріг)
ВАЖЛИВО: після SET_PENDING_ROLL — зупинись. Не описуй наслідки поки не отримаєш число.`;
  }
