...
- **Chat transcript scroll**: виправлено незалежний scroll для основного transcript rail після workspace shell refactor; чат знову скролиться всередині сесії як окремий reading region.
