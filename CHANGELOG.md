...
### Changed
- **Стиль відповідей Кіпера (ANT-72)**: prompt `headingStyle` (uk + en) перероблено з "2–4 абзаци" на "1–2 абзаци за замовчуванням, до 3 в емоційно важливих сценах; кожен абзац ≤ 3–4 речень". Додано явне правило розбивати діалоги NPC на окремі `[NPC:]` бульбашки. Відповіді стають щільнішими та легшими для читання.
