...
### Fixed
- **Keeper виводить `[Anton]:` перед відповіддю** — LLM плутав формат гравецького префіксу з нарацією. Інструкцію уточнено: цей префікс тільки вхідний (від гравців) і ніколи не використовується у відповідях Keeper.
